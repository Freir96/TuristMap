...
export default class Restaurant extends React.Component {
    ...
    componentDidMount() {
        console.log("mounted")
        let data = DescriptionService.getRestaurantDescriptionById(this.props.navigation.state.params.id)
        console.log(data)
        ...
        let images = ImageService.getrestaurantImages(this.props.navigation.state.params.id)
            ...
            <ScrollView style={{ backgroundColor: colors.darkPrimary }}>
                ...
                <View style={{ width: '80%', alignSelf: 'center' }}>
                    ...
                    {this.state.phone !== '' &&
                        <View style={styles.infoContainer}>
                            <View style={styles.iconContainer}>
                                <Image source={getIcon("phone")} style={styles.icon} />
                            </View>
                            <View style={{ flexDirection: 'column', marginLeft: 20 }}>
                                <View>
                    ...
                    <TouchableOpacity style={{ alignSelf: 'center', marginVertical: 15 }}
                        onPress={() => NavigationService.navigate("Reservation")}
                    >
                        <LinearGradient colors={['#628492', '#52717C', '#567581']} style={styles.gradient}>
